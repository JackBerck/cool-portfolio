      ...
      <div className="max-w-screen-xl container">
        <div className="flex justify-between flex-col lg:flex-row gap-4">
          <div className="lg:w-1/2">
            <h2 className="title-font-size font-semibold">
              Let's Connect & Collaborate
            </h2>
            <p className="mb-2">
              Feel free to reach out for any project or collaboration
              opportunities. I'm always open to discussing new ideas and working
              together to create something amazing.
            </p>
            <ul className="flex flex-col gap-2">
              <li className="w-fit">
                <a href="#" className="flex items-center gap-2">
                  <div className="rounded-full bg-dark-base text-light-base p-2 w-fit">
                    <svg
                      className="w-6 xl:w-8 aspect-square"
                      fill="currentColor"
                  ...
                  <span>zakidzlfkr@gmail.com</span>
                </a>
              </li>
              <li className="w-fit">
                <a href="#" className="flex items-center gap-2">
