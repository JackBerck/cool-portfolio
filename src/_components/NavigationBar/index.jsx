...
export default function NavigationBar() {
  ...
  return (
    <nav
      className={`section-padding-x fixed top-0 w-full z-[999] text-dark-base normal-font-size transition-all duration-300 bg-light-base shadow-md`}
    >
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto xl:px-0 py-4">
        ...
        <button
          type="button"
          className="lg:hidden text-dark-base"
          onClick={toggleMenu}
        >
          <svg
